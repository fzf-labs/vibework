...
export function PipelineTemplateList({ onEdit, onExecute }: PipelineTemplateListProps) {
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 mt-2 text-xs text-gray-500">
                  ...
                  <span>更新于 {formatDistanceToNow(template.updatedAt, { addSuffix: true, locale: zhCN })}</span>
                </div>
              </div>
